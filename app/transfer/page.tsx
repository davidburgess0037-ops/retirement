...
type PinArray = [string, string, string, string];
...
export default function TransferPage() {
  ...
  const [pin, setPin] = useState<PinArray>(["", "", "", ""]);
  ...
  const canContinueRecipient =
    ...
    /^\d{8,12}$/.test(recipient.account.trim());

  const amountError = useMemo((): string => {
    if (!amount) return "";
  ...
  function handlePinKeyDown(i: number, e: KeyboardEvent<HTMLInputElement>) {
    ...
    <div className="min-h-screen bg-mist">
      <header className="border-b border-gray-100 bg-white">
        <div className="mx-auto flex max-w-3xl items-center justify-between px-5 py-4">
          <Link
            href="/dashboard"
            className="flex items-center gap-2 text-sm font-semibold text-gray-600 hover:text-ink"
          >
            ← Dashboard
          </Link>
        ...
        {!receipt && step === 0 && (
          <div className="rounded-3xl bg-white p-7 shadow-card ring-1 ring-gray-100">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="label" htmlFor="rbank">
                  Bank name
                </label>
                <input
                  id="rbank"
              ...
              <div>
                <label className="label" htmlFor="racct">
                  Account number
                </label>
                <input
                  id="racct"
                ...
                />
                {recipient.account &&
                  !/^\d{8,12}$/.test(recipient.account) && (
                    <p className="mt-1.5 text-xs text-red-500">
                      Account numbers are 8–12 digits.
                    </p>
                  )}
              </div>
            </div>
          ...
          <div className="rounded-3xl bg-white p-7 shadow-card ring-1 ring-gray-100">
            ...
            <div className="mt-6 rounded-2xl border border-gray-100 bg-mist p-5">
              ...
              <div className="mt-1 flex items-baseline gap-1">
                <span className="font-display text-3xl font-bold text-gray-400">
                  $
                </span>
                <input
                  id="amt"
